...
install_hooks()
{
	...
	if [[ ! -e /home/pi/printer_data/config/klipper-btt-primus/.git/hooks/post-merge ]]
	then
 	   ln -s /home/pi/printer_data/config/klipper-btt-primus/scripts/ratos-post-merge.sh /home/pi/printer_data/config/klipper-btt-primus/.git/hooks/post-merge
	fi
	if [[ ! -e /home/pi/klipper/.git/hooks/post-merge ]]
	then
 	   ln -s /home/pi/printer_data/config/klipper-btt-primus/scripts/klipper-post-merge.sh /home/pi/klipper/.git/hooks/post-merge
	fi
	if [[ ! -e /home/pi/moonraker/.git/hooks/post-merge ]]
	then
 	   ln -s /home/pi/printer_data/config/klipper-btt-primus/scripts/moonraker-post-merge.sh /home/pi/moonraker/.git/hooks/post-merge
	fi
}
...
pi  ALL=(ALL) NOPASSWD: /home/pi/printer_data/config/klipper-btt-primus/scripts/ratos-update.sh
pi  ALL=(ALL) NOPASSWD: /home/pi/printer_data/config/klipper-btt-primus/scripts/klipper-mcu-update.sh
pi  ALL=(ALL) NOPASSWD: /home/pi/printer_data/config/klipper-btt-primus/scripts/moonraker-update.sh
#EOF
...
pi  ALL=(ALL) NOPASSWD: /home/pi/printer_data/config/klipper-btt-primus/scripts/change-hostname-as-root.sh
#EOF
