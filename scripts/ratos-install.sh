...
install_printer_config()
{
    ...
    tail -n +2 /home/pi/printer_data/config/klipper-btt-primus/templates/initial-printer.template.cfg > $PRINTER_CFG
}

install_udev_rules()
{
    report_status "Installing udev rules"
    sudo ln -s /home/pi/printer_data/config/klipper-btt-primus/boards/*/*.rules /etc/udev/rules.d/
}
