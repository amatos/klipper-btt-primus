...
source /home/pi/printer_data/config/klipper-btt-primus/scripts/ratos-common.sh
source /home/pi/printer_data/config/klipper-btt-primus/scripts/moonraker-ensure-policykit-rules.sh

update_symlinks()
{
  echo "Updating RatOS device symlinks.."
  rm /etc/udev/rules.d/98-*.rules
  ln -s /home/pi/printer_data/config/klipper-btt-primus/boards/*/*.rules /etc/udev/rules.d/
}
